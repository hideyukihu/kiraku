...
function Login() {
  ...
  return (
    <div className="App">
      <h2 className="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-4xl dark:text-white">買い物リストログイン画面</h2>
      <div>
      ...
      <nav className='my-5'>
        ...
        <Link href="/items/list" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mr-2">アイテム登録</Link>
